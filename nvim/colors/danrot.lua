...
hl(0, '@markup.list', {fg = colors.white})
hl(0, '@markup.raw', {fg = colors.silver})
hl(0, '@markup.strong', {bold = true})
hl(0, '@type', {fg = colors.white})
hl(0, '@type.builtin', {fg = colors.redDamask})
...
hl(0, 'cucumberFeature', {fg = colors.redDamask})
hl(0, 'cucumberBackground', {fg = colors.redDamask})
hl(0, 'cucumberScenario', {fg = colors.redDamask})
hl(0, 'cucumberTags', {fg = colors.white})
hl(0, 'cucumberGiven', {fg = colors.redDamask})
hl(0, 'cucumberWhen', {fg = colors.redDamask})
hl(0, 'cucumberThen', {fg = colors.redDamask})
...
hl(0, 'ngxDirective', {fg = colors.redDamask})
hl(0, 'ngxDirectiveBlock', {fg = colors.redDamask})
hl(0, 'ngxDirectiveControl', {fg = colors.redDamask})
